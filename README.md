...
| `plot-twist-design.md` | 反转与反套路设计（反转种子6问、反套路检查表5项、三岔路法则、情感核弹、结局设计要点） |
| `outline-template.md` | 大纲模板（章节规划、悬念线、反转设计区块） |
| `character-template.md` | 人物档案模板（含反身份/情感核弹字段） |
